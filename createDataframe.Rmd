title: "Lesson 2: Create your own data frame" output: html_document ---
...
```{r}
names <- c("German", "Luis", "Pedro", "Maxi")
```
...
```{r}
fruit <- c("Manzana", "Limón", "Frutilla", "Naranja", "Pera")
```
...
```{r}
fruit_rank_df <- data.frame(fruit, personal_rank)
